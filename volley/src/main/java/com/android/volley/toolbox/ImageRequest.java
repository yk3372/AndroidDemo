...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
        ...
        this(url, listener, maxWidth, maxHeight, scaleType, decodeConfig, errorListener, false);
    }

    // YK ADD:START
    public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight,
            ScaleType scaleType, Config decodeConfig, Response.ErrorListener errorListener, boolean isCircle) {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            ...
            // YK ADD:START
            if (mIsCircle) {
                Bitmap bmp = Utils.circleToBitmap(bitmap);
                if (bmp != bitmap) {
                    bitmap.recycle();
                    bitmap = bmp;
                }
                bmp = Utils.zoomBitmap(bitmap, mMaxWidth, mMaxHeight);
                if (bmp != bitmap) {
                    bitmap.recycle();
                    bitmap = bmp;
                }
